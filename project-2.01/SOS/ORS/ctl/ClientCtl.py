...
#         self.form['fullName'] = requestForm.get('fullName', '')
#         self.form['appointmentDate'] = requestForm.get('appointmentDate', '')
#         self.form['phone'] = requestForm.get('phone', '')
#         self.form['illness'] = requestForm.get('illness', '')
#
#     def form_to_model(self, obj):
#         pk = int(self.form['id'])
#         if pk > 0:
...
#         else:
#             if (DataValidator.isDate(self.form['appointmentDate'])):
#                 inputError['appointmentDate'] = "Login ID must be like student@gmail.com"
#                 self.form['error'] = True
#
#         if (DataValidator.isNull(self.form['phone'])):
#             inputError['phone'] = "phone is Required"
#             self.form['phone'] = True
#         else:
#             if (DataValidator.isphonecheck(self.form['phone'])):
#                 inputError['phone'] = "phone is contain"
#                 self.form['error'] = True
#
#         if (DataValidator.isNull(self.form['illness'])):
#             inputError['illness'] = "illness  is required"
#             self.form['error'] = True
#         else:
#             if (DataValidator.isphonecheck(self.form['illness'])):
#                 inputError['illness'] = "Incorrect birthDate, should be YYYY-MM-DD"
#                 self.form['error'] = True
#
#         return self.form['error']
#
